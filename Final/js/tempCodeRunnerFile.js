...
//     let currIndex = assets2024[state][constit].candidates[0].cId;
//     let resStatus = assets2024[state][constit].rsDecl;
//     let margin = 0;
//     let candidateVotes = 0;
//     let opponentVotes = 0;

//     if(currIndex === candId) {
//         candidateVotes = assets2024[state][constit].candidates[0].vts;
//         if (assets2024[state][constit].candidates[1]) {
...
//         }
//     } else {
//         for (const candidate of assets2024[state][constit].candidates) {
//             if (candidate.cId === candId) {
//                 candidateVotes = candidate.vts;
//                 break;
//             }
//         }
//         opponentVotes = assets2024[state][constit].candidates[0].vts;
