  ...
  function createSlide(
    ...
    <div class="card swiper-slide">
        <span class="state_name">${toTitleCase(
          const_name
        )} <span class="state_party_slot">(${toTitleCase(state)})</span></span>
        ...
        <div class="cand_desc2">
          ...
          <span style="width:${bar_length2}%;" class="trailbar"></span><span style="color:black;margin:3px">${new Intl.NumberFormat(
      "en-IN"
    ).format(votes2)}</span>
          </span>
            </div>
